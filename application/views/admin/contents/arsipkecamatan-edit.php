<div class="main-content container-fluid p-0">
    <div class="container-fluid dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div id="info"></div>
                <div class="alert alert-info" role="alert">Kosongi file jika tidak ingin mengganti</div>
                            ...
                            <div class="row">
                                <div class="col-12 p-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" value="<?php echo $file['nama'] ?>" name="nama" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" value="<?php echo $file['nomor'] ?>" name="nomor" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-lg" value="<?php echo  date('Y-m-d', strtotime($file['tanggal']))  ?>" name="tanggal" required>
                                        <div class="invalid-feedback">
                                            Tanggal kosong.
                                        </div>
                                    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data['Status'] == 'Sukses') {
                    ...
                    $(window).scrollTop(0);
                    setTimeout(function() {
                        window.location.href = "<?php echo base_url('admin/arsipkecamatan/' . $this->session->userdata('KodeInstansi') . '/' . $bagian . '/' . encrypt_this($file['id_folder'])) ?>";
                    }, 1500);
                } else {
