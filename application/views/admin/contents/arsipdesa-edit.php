                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><b><?php // echo $detail['nama'] 
                                                                                            ?></b></li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12 p-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="nama" value="<?php echo $file['nama'] ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="nomor" value="<?php echo $file['nomor'] ?>" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-lg" name="tanggal" value="<?php echo  date('Y-m-d', strtotime($file['tanggal']))  ?>" required>
                                        <div class="invalid-feedback">
                                            Tanggal kosong.
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo encrypt_this($file['id']) ?>" name="id">
                                        <input type="hidden" value="<?php echo encrypt_this('1') ?>" name="kategori">
                                        <input type="hidden" value="<?php echo encrypt_this($file['id_folder']) ?>" name="kode">
...
<script>
    $("#formedit").on("submit", function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url('api/prosses/editfile') ?>",
            type: 'POST',
            dataType: 'Json',
            data: formData,
            contentType: false,
            ...
            success: function(data) {
                if (data['Status'] == 'Sukses') {
                    ...
                    $(window).scrollTop(0);
                    setTimeout(function() {
                        window.location.href = "<?php echo base_url('admin/arsipdesa/' . $this->session->userdata('KodeInstansi') . '/' . encrypt_this($file['id_folder'])) ?>";
                    }, 1500);
                } else {
