        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="email-title">
                    ...
                    <?php
                    if (!empty($bagian)) {
                        echo ' / <a href="' . base_url('admin/bagiankecamatan/' . $this->session->userdata('KodeInstansi') . '/' . encrypt_this($detail['parent'])) . '">' . $bagian . '</a>';
                    }
                    if (!empty($detail)) {
                        echo ' / ' . $detail['nama'];
                        if ($this->session->userdata('Level') == 2) {
                            echo '<div class="float-right">
                            <a href="' . base_url('admin/tambaharsipkecamatan/' . $bagian . '/' . encrypt_this($detail['id'])) . '" title="Upload Arsip" class="btn btn-sm btn-success"><i class="fas fa-upload"></i> Upload File</a>
                            </div>';
                        } else {
                            echo '<div class="float-right">
                                    ...
                                    <td>
                                        <div class="input-group-prepend be-addon">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="<?php echo base_url('admin/editarsipkecamatan/' . $bagian . '/' . encrypt_this($files->id)) ?>" class="dropdown-item text-grey"><span class="fa fa-edit"></span> Edit</a>
